...
export function loadConfig(env = process.env) {
  ...
  const config = {
    ...
    configurationTwoPersonApproval: parseBoolean(env.PLATFORM_CONFIG_TWO_PERSON_APPROVAL, false),
    ...
    proxyP95ThresholdMs: parseInteger(env.PLATFORM_PROXY_P95_THRESHOLD_MS, 3000, { min: 100, max: 120000 }),
    proxyErrorRatePercent: parseInteger(env.PLATFORM_PROXY_ERROR_RATE_PERCENT, 1, { min: 1, max: 100 }),
    proxyAlertMinimumRequests: parseInteger(env.PLATFORM_PROXY_ALERT_MINIMUM_REQUESTS, 50, { min: 5, max: 10000 }),
