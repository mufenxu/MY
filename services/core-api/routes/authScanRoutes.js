...
router.get('/qrcode/list', authMiddleware.verifyToken, authorize('admin', 'super_admin'), authScanController.listQRCodes);
...
// Logs
router.get('/logs', authMiddleware.verifyToken, authorize('admin', 'super_admin'), authScanController.getAuditLogs);
